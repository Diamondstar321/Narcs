...
"""
Defines various menus used in the application with options linked to functions that implement each feature.
"""
...
home_menu = Menu('home', '\nHome (CUSTOMER):', [
    ...
    Option("Edit Account Information", 'edit_account_information(session)'),
